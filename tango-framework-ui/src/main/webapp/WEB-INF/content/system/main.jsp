...
<head>
    <meta charset="utf-8"/>
    <title>framework of tango</title>
    ...
    <link rel="stylesheet" href="${stp}/bootstrap/css/font-awesome.min.css"/>
    <!--[if IE 7]>
    <link rel="stylesheet" href="${stp}/bootstrap/css/font-awesome-ie7.min.css"/>
    <![endif]-->
    <!-- fonts -->
    <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Open+Sans:400,300"/>
    <!-- ace styles -->
    <link rel="stylesheet" href="${stp}/bootstrap/css/ace.min.css"/>
    <link rel="stylesheet" href="${stp}/bootstrap/css/ace-rtl.min.css"/>
    <link rel="stylesheet" href="${stp}/bootstrap/css/ace-skins.min.css"/>
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="${stp}/bootstrap/css/ace-ie.min.css"/>
    <![endif]-->
    <script src="${stp}/bootstrap/js/ace-extra.min.js"></script>
    <!--[if lt IE 9]>
    <script src="${stp}/bootstrap/js/html5shiv.js"></script>
    <script src="${stp}/bootstrap/js/respond.min.js"></script>
    <![endif]-->
</head>
...
<script type="text/javascript">
    window.jQuery || document.write("<script src='${stp}/bootstrap/js/jquery-2.0.3.min.js'>" + "<" + "script>");
</script>
...
<!--[if IE]>
<script type="text/javascript">
    window.jQuery || document.write("<script src='${stp}/bootstrap/js/jquery-1.10.2.min.js'>" + "<" + "script>");
</script>
<![endif]-->

<script type="text/javascript">
    if ("ontouchend" in document) document.write("<script src='${stp}/bootstrap/js/jquery.mobile.custom.min.js'>" + "<" + "script>");
</script>
<script src="${stp}/bootstrap/js/bootstrap.min.js"></script>
<script src="${stp}/bootstrap/js/typeahead-bs2.min.js"></script>

<!-- page specific plugin scripts -->

<!--[if lte IE 8]>
<script src="${stp}/bootstrap/js/excanvas.min.js"></script>
<![endif]-->

<script src="${stp}/bootstrap/js/jquery-ui-1.10.3.custom.min.js"></script>
<script src="${stp}/bootstrap/js/jquery.ui.touch-punch.min.js"></script>
<script src="${stp}/bootstrap/js/jquery.slimscroll.min.js"></script>
<script src="${stp}/bootstrap/js/jquery.easy-pie-chart.min.js"></script>
<script src="${stp}/bootstrap/js/jquery.sparkline.min.js"></script>
<script src="${stp}/bootstrap/js/flot/jquery.flot.min.js"></script>
<script src="${stp}/bootstrap/js/flot/jquery.flot.pie.min.js"></script>
<script src="${stp}/bootstrap/js/flot/jquery.flot.resize.min.js"></script>

<!-- ace scripts -->

<script src="${stp}/bootstrap/js/ace-elements.min.js"></script>
<script src="${stp}/bootstrap/js/ace.min.js"></script>
